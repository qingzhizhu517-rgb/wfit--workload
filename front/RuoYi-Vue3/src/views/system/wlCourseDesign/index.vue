<template>
  <div class="app-container">
    ...
    <el-alert
      ...
      :closable="false"
      class="mb8"
      title="核算公式：工作量 = 学分 × 指导人数(上限20) × 每学分常量（规则 CONST_COURSE_DESIGN，默认 0.4）"
    />

    <el-table
      v-loading="loading"
      :data="wlCourseDesignList"
      stripe
      empty-text="暂无数据"
...
const detailFields = [
  ...
  { label: '课程设计学分 J4', prop: 'J4' },
  { label: '指导人数 R4', prop: 'R4', type: 'int' }
]
