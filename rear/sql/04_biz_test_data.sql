...
-- allowance_rate 存【学年值】（第十六条）；督导例外存学期值（第十七条 15/学期）
-- -----------------------------------------------------------
...
(2, 3, '教研室主任', '数学教研室', '2025-09-01', '2026-01-15', 180.00, '2025-2026-1', 0)
...
-- 李四: 班主任, 按任职天数折算 (公式: 学期标准学时 × 任职天数/学期天数；180/学年 ÷2 = 90/学期)
(511, 1, '班主任', 90.00, '标准180学时/学年÷2 × 全学期任职');
