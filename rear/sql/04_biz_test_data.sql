...
-- allowance_rate 存教务认定的【本学期岗位减免工作量】，G11 直接同步，不折半、不按日期折算
-- -----------------------------------------------------------
INSERT INTO biz_role_assignment (id, user_id, role_type, target, start_date, end_date, allowance_rate, semester, status) VALUES
(1, 4, '班主任', '英语2301班', '2025-09-01', '2026-01-15', 90.00, '2025-2026-1', 0),
(2, 3, '教研室主任', '数学教研室', '2025-09-01', '2026-01-15', 90.00, '2025-2026-1', 0)
...
-- 李四: 班主任，本学期岗位减免工作量直接计入 G11
(511, 1, '班主任', 90.00, '岗位减免工作量（本学期），计入 G11');
