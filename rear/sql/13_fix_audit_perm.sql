...
--   20206 approve 审核通过 / 20207 reject 驳回 / 20208 sign 签字（已于 2026-09-10 移除）/
--   20209 unlock 解锁
--
-- ⚠ 2026-09-10 起本脚本的第 3 步已被 17_simplify_approval.sql 覆盖：
--   审批简化为两级后不再有「院领导待签」环节，院领导的 reject(20207) 授权随后被撤销。
--   本脚本保留第 3 步是为了保持历史可追溯；新库按 01→…→13→16→17 顺序执行，终态正确。
-- ============================================================================
